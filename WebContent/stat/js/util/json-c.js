...
function Process(){
  ...
  var json = $id("getJsonSchemaFloater-text").value;
  var html = "";
  try{
    if(json == "") json = "\"\"";
    var obj = eval("["+json+"]");
...
function EnsureIsPopulated(){
  ...
  if(!$id("Canvas").innerHTML && !!$id("getJsonSchemaFloater-text").value) Process();
...
function LinkToJson(){
  ...
  var val = $id("getJsonSchemaFloater-text").value;
